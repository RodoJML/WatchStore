...
const loginPage = 'fixed grid items-center text-center bg-transparent w-full h-full ease-in-out duration-500 shadow-2xl backdrop-blur border border-white border-opacity-20 z-30 p-10 sm:px-20 md:px-40 lg:px-60 xl:px-80 z-20 overflow-scroll';
