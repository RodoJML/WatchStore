    ...
    return (
        <div className={`${active ? "visible" : "hidden"} absolute w-screen p-3 transition-all ease-in-out duration-700 ${transition2 ? (finished ? " -left-full " : " left-0 ") : (transition1 ? " right-0 " : " -right-full ")}`}>
            <div className="flex justify-center text-white text-shadow-lg shadow-black text-center font-bold text-sm px-5 mt-4">
                Para una organización eficiente esta página cuenta con un sistema de "stock". Antes de publicar su reloj, este se incluira a un inventario.
            </div>
                ...
                <form className="grid gap-3" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-3 gap-1 bg-black bg-opacity-40 px-2 py-1 rounded text-shadow shadow-black">
                        ...
                        <div className="flex col-span-2 overflow-scroll whitespace-nowrap text-nowrap">
                            ...
                            <div className="mr-1">
                                {sessionStatus.brands.find((brand) => brand.brand_id == mainForm.step1.brand)?.brand_name}
                            </div>

                            <div>
                                {mainForm.step2.model}
                            </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <div className="bg-black bg-opacity-40 p-2 rounded col-span-1">Condicion: </div>
                        ...
                        <div className="bg-black bg-opacity-40 p-2 rounded col-span-1">Cantidad: </div>
