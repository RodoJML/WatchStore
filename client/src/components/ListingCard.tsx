...
export default function ListingCard() {
    ...
    return (
        <div className="shadow-2xl shadow-black m-2 relative">
                ...
                <div className="grid bg-stone-900 rounded-b aspect-video text-center whitespace-nowrap border-t border-opacity-40 border-white items-center">
                    <div className="grid col-span-1 p-1">

                        <div className="-mb-1 overflow-scroll">
                            <a className="text-white uppercase font-extrabold font-serif text-lg">panerai</a>
                        </div>

                        <div className="grid">
                            <a className="text-white font-thin capitalize text-lg -mb-1 overflow-scroll">luminor marina</a>
                            ...
                            <div className="grid grid-cols-5 items-center text-white overflow-scroll">
                                ...
                                <div className="col-span-3 text-left overflow-visible">
                                    <span className="text-xs">₡</span><span className="text-lg font-extrabold text-lume-100">100.000</span>
                                    <span className="text-xs ml-1 text-white text-opacity-50">($200)</span>
                                </div>
                                    
                            </div>
                        </div>

                        <div className="grid grid-cols-2 text-white items-center text-xs">
                            ...
                            <div className="flex mr-3 items-center overflow-scroll">
