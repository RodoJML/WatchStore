...
export default function LoginForm() {
    ...
    return (
        <form className="relative grid" onSubmit={handleSubmit}>
            ...
            <input className="h-10 mb-4 rounded border pl-2" type="password" pattern="^(?=.*\d)(?=.*[a-zA-Z])(?=.*[!@#$%^&*-]).{8,}$" minLength={8} name="user_password" placeholder="Contraseña" onChange={handleChange} required title="test" />
